...
* [Schrift-Bibliothek](https://inkstitch.org/de/fonts/font-library/)

## +++ Neue Sticharten +++
* Kurvenfüllung
  * kurviger Füllstich der einer benutzerdefinierten Führungslinie folgt
  * [Kurvenfüllung](https://inkstitch.org/de/docs/stitches/guided-fill/)
* Konturfüllung
  * Spiralförmige Füllung die sich an der Objektkontur orientiert
  * [Konturfüllung](https://inkstitch.org/de/docs/stitches/contour-fill/)
* Ripple-Stich
  ...
  * [Ripple-Stich](https://inkstitch.org/de/docs/stitches/ripple-stitch/)
...
* Automatisch geführter Geradstich
  ...
  * [Automatisch geführter Geradstich](https://inkstitch.org/de/docs/stroke-tools/)
* Farbpalette erstellen
  * aus Textobjekten Ink/Stitch kompatible Farbpalleten erstellen
  * [Farbpalette erstellen](https://inkstitch.org/de/docs/thread-color/#farbpalette-erstellen)
* Farbpalette zu Text
  * konvertiert eine bestehende Farbpalette in SVG-Textelemente
  * vereinfacht das Bearbeiten und erstellen von Farbpalleten
  * [Farbpalette zu Text](https://inkstitch.org/de/docs/thread-color/#farbpalette-zu-text)
* Cutwork Segementierung
  ...
  * [Cutwork](https://inkstitch.org/de/docs/cutwork/)
...
* Minimale Sitchlänge (Ink/Stitch Einstellungen)
  ...
  * [Einstellungen](https://inkstitch.org/de/docs/preferences/)
