---
layout: single
title:  "Ink/Stitch 3.2.1"
date:   2025-06-07
categories: Releases
---
Ink/Stitch v3.2.1 met l'accent sur les polices. De nouvelles options dans l'outil de lettrage facilitent le tri des couleurs dans les polices multicolores et l'alignement du texte sur plusieurs lignes. Les options d'orientation des polices permettent le traitement des polices qui  s'écrivent de gauche à droite (par exemple, les polices arabes ou hébraïques).
...
* [Bluenesia Satin](/fr/fonts/bluenesia/)

  ![Bluenesia Satin](/assets/images/fonts/bluenesia_satin.png)
