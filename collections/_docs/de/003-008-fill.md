...
Füllwinkel | Standardmäßig 90 Grad zum Winkel des Deckstichs. Das ist in den meisten Fällen die beste Wahl. Manchmal wirst du aber den Winkl manuell setzen wollen. <!-- Es ist auch möglich, eine durch Kommata getrennte Liste einzugeben, um mehrere Unterlagen zu erzeugen.-->It is also possible to receive multiple underlays by entering a space separated list to the underlay direction .
