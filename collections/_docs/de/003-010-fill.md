...
Zugausgleich (%)                |![Pull compensation percent](/assets/images/docs/fill-pull_comp_mm.jpg)| Zusätzliche Zugkompensation, die als Prozentwert der ursprünglichen Länge variiert. Zwei durch ein Leerzeichen getrennte Werte können für einen asymmetrischen Effekt verwendet werden.
