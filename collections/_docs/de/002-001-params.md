...
---|---|---
[Linie](/docs/params/#stroke-params) |[Laufstich](/docs/stitches/running-stitch/), [Manueller Stich](/docs/stitches/manual-stitch/), [Zick-Zack-Stich](/docs/stitches/zigzag-stitch/), [Bohnenstich](/docs/stitches/bean-stitch/) | (gestrichelte) Linie
[Satin](/docs/params/#satin-params)   |[Satinkolumne](/docs/stitches/satin-column), [E-Stitch](/docs/stitches/e-stitch) | Zwei kombinierte Linien (mit optionalen "Sprossen")
[Automatischer Füllstich](/docs/params/#auto-fill-params)     |[Füllstich](/docs/stitches/fill-stitch/) | geschlossener Pfad mit Füllfarbe
...
Manuelle Stichpositionierung          | Aktiviert den [manuellen Stichmodus](#manual-stitch-mode)
...
Zick-Zack Abstand (Spitze zu Spitze)  | ◦ Stichlänge im [Zick-Zack-Modus](#zig-zag-stitch-mode-previously-simple-satin)<br>◦ Die Höhe wird durch die Linienbreite definiert
...
Laufstichlänge                  |![Running stitch length example](/assets/images/docs/params-fill-running_stitch_length.png) | Stichlänge um den Umriss des Füllbereichs, der beim Übergang von Abschnitt zu Abschnitt verwendet wird.
