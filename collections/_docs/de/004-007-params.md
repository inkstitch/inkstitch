...
Note: Only the settings that have just been modified will be saved. These settings are marked with a pencil icon next to their name. You may need to modify a setting twice for the pencil icon to appear.
