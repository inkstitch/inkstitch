...
`Extensions > Ink/Stitch  > Params` åbner Params-dialogen, hvor du kan bestemme detaljerne for dine valgte sting.
...
---|---
Running stitch along paths      |Denne må være aktiv for at disse sætninger skal kunne blive gennemført.
Manual stitch placement       |Aktiverer [Manuel sømmodus](/docs/stitches/manual-stitch/)
Repeats                       |◦ Definerer hvor mange gange, der skal blive syet frem og tilbage langs med linjen<br />◦ Default: 1 (Der vil blive syet en gang fra start til enden af linjen)<br />◦ Ulige numre: Stingene vil ende i enden af linjen<br />◦ Ulige numre: Stikningen vil vende tilbage til linjens start.

Bean stitch number of repeats |◦ Aktiviserer [Bean Stitch Mode](/docs/stitches/bean-stitch/)<br />◦ Hvert sting vil blive syet tilbage så mange gange.<br />◦ En værdi på 1 vil 3-doble hvert sting (frem, tilbage og frem igen).<br />◦ 

En værdi på 2 vil 5-doble hvert sting etc.<br />◦ Lægges bare til "running stitch".
Running stitch length|Længde af stingene i [Running Stitch Mode](/docs/stitches/running-stitch/)
Zig-Zag spacing (peak-to-peak)|◦ Længde af stingene i [Zig-Zag Mode](/docs/stitches/zigzag-stitch/)<br>◦ Højden er defineret ved linje-bredden. 
Allow lock stitches           |Aktiviserer hæfte-sting i kun ønsket positioner

**Info:** Hvis et objekt består af mange Paths, så vil de blive syet efter hinanden i orden med et hoppesting mellem hver af dem.
{: .notice--info }
...
Settings|Description
---|---
Manually routed fill stitching|Må være aktiviseret for at disse indstillinger kan blive udført.
Angle of lines of stitches|Vinklen på rækkerne af sting, i grader. 0 er vandret, og vinklen øges i retning mod uret. Negative vinkler er tilladt
Maximum fill stitch length|Længden af hvert sting i en række. "Max" skyldes, at et kortere kan bruges i starten eller slutningen af en række.
Spacing between rows|Afstanden mellem sting-rækkerne (sømmen).
Skip last stitch in each row|Det sidste sting i hver række er ganske nært til det første sting i den næste række.
Stagger row this many times before repeating|Stingene er forskudt, så tilstødende rækker af sting ikke alle falder i samme kolonne (hvilket ville skabe en distraherende daleffekt). Indstilling af dette dikterer, hvor mange rækker der er fra hinanden, der vil være mellem stingene, før de falder i samme kolonneposition.
Flip fill| Flip-indstillingen kan hjælpe dig med at dirigere din stingbane. Når du aktiverer vending, går syningen fra højre til venstre i stedet for fra venstre mod højre. Ved at vende og rotere yderligere 180 grader (ved at tilføje eller trække 180 fra **angle**), kan du få udfyldningssting for en given form til at starte fra et hvilket som helst af de fire mulige hjørner.
Force lock stitches|Sy hæfte-sting efter syning af dette element, selvom afstanden til det næste objekt er kortere end defineret af værdien for "collapse length value" i "Ink/Stitch-preferences".
Allow lock stitches|Aktiverer kun hæfte-sting kun i ønskede positioner.
## Presets

Med Presets har du mulighed for at lagre dine foretrukne sting-indstillinger, så du kan bruge dem når du ønsker det.
