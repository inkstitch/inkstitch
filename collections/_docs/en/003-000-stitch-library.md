...
{% include folder-galleries path="butterfly-fill-project/satin/" captions="1:Satin swirl;2:Satin with randomized stitch length and staggered split stitches;3:Multicolor-Satin" %}
