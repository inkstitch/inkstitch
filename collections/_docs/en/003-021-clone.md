...
---|---|---
Custom Fill Angle||If set, all fill elements that this clones will use this value for their fill angle, instead of being based off of the transform as above.
