...
Bean stitch number of repeats |Determines the number of times to repeat each stitch.<br />◦ A value of `0` does not repeat the stitch (normal stitch)<br/>◦ A value of `1` repeats each stitch once (forward, back, forward).<br />◦ A value of `2` repeats the stitch twice. <br />
