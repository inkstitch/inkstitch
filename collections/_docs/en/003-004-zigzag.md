...
Further stitch details can be managed with [`Extensions > Ink/Stitch > English > Params`](/docs/params/#stroke-params).

## Tips:

### Satin Column: A Better Option

It is not recommended to use the Zig-Zag Stitch Mode to create a satin border, use [Satin Column](/docs/stitches/satin/) instead.
