...
Since Ink/Stitch v1.11.0 it is possible to set start and end points for autofill objects. You will need to install [Ink/Stitch visual commands](/docs/commands/) for this purpose.
