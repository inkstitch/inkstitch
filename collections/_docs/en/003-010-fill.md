...
Pull compensation percent          |![Pull compensation percent](/assets/images/docs/fill-pull_comp_mm.jpg)| Additional pull compensation which varies as a percentage of row width. Two values separated by a space may be used for an asymmetric effect.
