...
Avant d'enregistrer un nouveau préréglage, vérifier que tous les paramètres que vous souhaitez prendre en compte (autre que les paramètres par défaut) sont bien activés, ce qui est visible par la présence d'un crayon a coté du nom du paramètre (au besoin modifier à nouveau la valeur du paramètre, deux fois pour faire apparaitre le crayon)
Même procédure pour la modification d'un réglage que l'on va écraser.
