...
|Méthode de remplissage|Remplissage tatami| Doit être sur Remplissage Tatami.|
...
|Angle des rangées de points|![Angle exemple](/assets/images/docs/params-fill-angle.png) |L'angle des rangées de points, en degrés. 0 est horizontal et l'angle augmente dans le sens contraire des aiguilles d'une montre. Les angles négatifs sont autorisés.|
Boucher les espaces entre sections |![Gap filling](/assets/images/docs/fill_gap_filling.jpg)| Ajoute des rangées supplémentaires pour compenser les espaces entre les sections causés par la distorsion. Les rangées sont toujours ajoutées par paires donc ce nombre sera arrondi au nombre pair supérieur le plus proche.
...
|Forcer les points d'arrêts |☑|Force un point d'arrêt après l'objet indépendamment de la valeur de "longueur minimum de saut"
...
---|---|---
Remplissage| ☑ |Doit être activé pour que ces paramètres prennent effet.
Méthode de remplissage|Remplissage Manuel  (Legacy)| Doit être sur Remplissage Manuel Legacy
Élargir|![Expand example](/assets/images/docs/params-fill-expand.png) |Etend la forme avant le point de remplissage pour compenser les écarts entre les formes en raison de l'étirement du tissu.
