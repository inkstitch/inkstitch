...
Supprime les noeuds dupliqués à l'intérieur d'un nombre donné de noeuds consécutifs et à une distancce maximale donnée

Par exemple dans un fichier machine, ou dans une prévisualisation de plan de broderie, permet de transformer unn point triple en point simple

### Usage

* Sélectionner  un ou des traits 
* Lancer  `Extensions > Ink/Stitch > Édition > Supprimer les points dupliqués`
* Modifier les réglaves à votre connvenance
* Appliquer
...
Parfois vous souhaitez sélectioner tous les éléments de broderie d'un certain type (par exemple toutes les colonnes satins avec un chemin central comme sous couche). Cette extension vous permet de le faire.
