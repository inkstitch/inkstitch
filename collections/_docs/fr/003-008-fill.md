...
Avant la version courante, les angles de remplissage devaient être séparés par des virgules et non des espaces. Si vous utilisez d'anciens fichiers, vous devrez les [mettre à jour](/fr/docs/troubleshoot/#mettre-à-jour-le-svg-dinkstitch)
