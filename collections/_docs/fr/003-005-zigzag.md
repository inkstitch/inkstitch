...
Angle du Zig-Zag                   |Tourner la direction des zig-zags de cet angle (en degrés). Crée des effets de rayons sur les courbes.
...
|Forcer les points d'arrêts        |Force un point d'arrêt après l'objet indépendament de la valeur de "Saut de fil" |
