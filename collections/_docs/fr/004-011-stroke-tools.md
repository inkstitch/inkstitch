...
Par défaut, l'extension choisira de commencer par le nœud le plus à gauche et de terminer par le nœud le plus à droite même si ces nœuds ne sont pas des nœuds terminaux. Vous pouvez attacher les commandes " Début/Fin d'agencement automatique de point droit" pour forcer les positions de début et de fin.
{: .notice--info }

### Options

- Cocher **Ajouter des nœuds aux intersections** donnera un meilleur résultat de routage, avec des chemins de dessous qui auront leurs extrémités aux intersections ou aux nœuds terminaux. Ne décocher cette option que si vous avez manuellement ajouté des nœuds là où vous souhaitez les coupures de chemin.
...
1. Sélectionnez la ou les colonnes satin que vous souhaitez convertir en point droits.
...
* Utilisez l'outil nœuds pour les éventuelles corrections
...
- Sélectionner les éléments que vous souhaitez convertir
