...
Intervertir |☑  ou ▢|  Si toute les lignes sont brodées, revient à parcours le plan de broderie à l'envers. Si des lignes sont sautées, les deux paramètres de saut de lignes sont a aussi interversés. 
