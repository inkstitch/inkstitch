...
##  Comment la créer
A partir d'un  **trait (couleur de contour mais pas de remplissage)** qui peut être un simple chemin  simple (la décomposition n'a aucun effet sur lui) , ou un  chemin  combinant deux sous chemins.
...
---|---|---
Distance grille || Une valeur i une valeur positive est rentrée, en plus des ondulations nopérant dans ce cas

### Guidage additionnel
Il existe deux méthodes pour guidage additionnel de déplacement des ondulations

## Chemin simple uniquement 
