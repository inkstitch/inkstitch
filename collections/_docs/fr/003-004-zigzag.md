...
D'autres détails du point peuvent être gérés via [`Extensions > Ink/Stitch  > Paramètres`](/docs/params/#stroke-params).

## Astuce:

### Colonne Satin: Une meilleure option

Il n'est pas recommandé d'utiliser le mode de points Zig-Zag pour créer un point satin., utiliser plutôt les  [Colonnes satin](/docs/stitches/satin-column/).
...
Utilisez donc plutôt les [Colonnes Satin](/docs/stitches/satin-column/).
