...
cd geos-3.12.1
cmake -S . -B _build_vs2022x32 -G "Visual Studio 17 2022" -A Win32 -DCMAKE_INSTALL_PREFIX=%GEOS_INSTALL% -DCMAKE_GENERATOR_TOOLSET=host=x64

cmake --build _build_vs2022x32 --config Release -j 16 --verbose
cd _build_vs2022x32
cmake --install .
