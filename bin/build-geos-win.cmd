@echo off
mkdir all
SET GEOS_INSTALL=C:\Users\foo\Downloads\all
...
xcopy %GEOS_INSTALL%\bin\geos_c.dll "C:\Program Files (x86)\Python38-32" /E /H /C /I

xcopy %GEOS_INSTALL%\bin\geos.dll "C:\Program Files (x86)\Python38-32" /E /H /C /I
