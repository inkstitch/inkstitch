...
class CrossStitchHelperFrame(wx.Frame):
    ...
    def widgets_and_panels(self):
        ...
        self.box_x = wx.SpinCtrlDouble(self.settings_panel, value='3', min=0.5, max=100, initial=3, inc=0.01)
        ...
        self.box_y = wx.SpinCtrlDouble(self.settings_panel, value='3', min=0.5, max=100, initial=3, inc=0.01)
