...
fill_choices = [
    ParamOption("running_stitch_length_mm", "Running Stitch Length mm"),
    ParamOption("running_stitch_tolerance_mm", "Running Stitch Tolerance mm"),
    ParamOption("max_stitch_length_mm", "Maximum Stitch Length mm (Tatami Fill, Contour Fill, Guided Fill)"),
    ParamOption("angle", "Angle (Tatami Fill)"),
    ...
    ParamOption("staggers", "Staggers (Tatami Fill, Guided Fill"),
