...
def inner_to_outer(tree, polygon, offset,
                   ...
                   enable_random, random_delta, random_seed):
    ...
    stitches = running_stitch(points, stitch_length, tolerance, enable_random, random_delta, random_seed)
...
def single_spiral(tree, stitch_length, tolerance, starting_point, enable_random, random_delta, random_seed):
    """Fill a shape with a single spiral going from outside to center."""
    return _spiral_fill(tree, stitch_length, tolerance, starting_point, enable_random, random_delta, random_seed, _make_spiral)


def double_spiral(tree, stitch_length, tolerance, starting_point, enable_random, random_delta, random_seed):
    """Fill a shape with a double spiral going from outside to center and back to outside. """
    return _spiral_fill(tree, stitch_length, tolerance, starting_point, enable_random, random_delta, random_seed, _make_fermat_spiral)


def _spiral_fill(tree, stitch_length, tolerance, close_point, enable_random, random_delta, random_seed, spiral_maker):
    ...
    return running_stitch(path, stitch_length, tolerance, enable_random, random_delta, random_seed)
