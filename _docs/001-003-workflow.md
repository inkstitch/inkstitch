...
Try to following steps in order to test the extension and to learn about basic functionality.
...
**Info:** Ink/Stitch doesn't understand rectangles, circles, and the like, and ignores them.
{: .notice--info }
...
* Select the format of your machine.
* Type a directory name where you can find your files. E.g. `C:\Users\%USERNAME%\Documents` on Windows. Ink/Stitch will remember this information.
...
### Step 5 - Stitching Out the Design
