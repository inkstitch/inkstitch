...
To print your documents click on `Print` at the top of the page. Alternatively hit `Ctrl+P`. This will open the print dialog of your browser. Make sure the printing size fits to your settings. For printing to PDF choose your PDF printer.
...
3. When opening the Print Preview Ink/Stitch created a popup-window with a `Close` button, which you could press now. In this case the browser will remain open. Any changes you perform to the document now, will be lost the next time you open the preview.
